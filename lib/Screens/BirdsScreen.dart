            ...
            children: <Widget>[
              ...
              Expanded(
                child: Row(
                    ...
                    children: <Widget>[
                      Expanded(child: AnimalAnimation('assets/BirdDuck.png',(){p.SoundClick('SoundBirdDuck.mp3');},(){p.SoundClick('NameBirdduck.mp3');})),
              ...
              Expanded(
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: <Widget>[
                      Expanded(child: AnimalAnimation('assets/Birdhen.png',(){p.SoundClick('SoundBirdchicken.mp3');},(){p.SoundClick('NameBirdhen.mp3');})),
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                    ...
                    Expanded(child: AnimalAnimation('assets/parrot.png',(){p.SoundClick('SoundBirdParrot.mp3');},(){p.SoundClick('NameBirdparrot.mp3');})),
                     Expanded(child: AnimalAnimation('assets/Birdswoodpecker.png',(){p.SoundClick('SoundBirdWoodpecker.mp3');},(){p.SoundClick('NameBirdtoucan.mp3');})),
