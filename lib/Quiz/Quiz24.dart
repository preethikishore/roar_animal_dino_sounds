...
import 'package:roar_animal_dino_sounds/Quiz/Quiz25.dart';
...
class Quiz24 extends StatelessWidget {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Expanded(child: QuizPanel('Toucan','NameBirdtoucan.mp3')),
                    Expanded(
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: <Widget>[
                          Expanded(
                            child: HomeimageContainer('assets/B07.png',(){
                          ...
                          Expanded(
                            child: HomeimageContainer('assets/B06.png',(){
                    ...
                    Expanded(
                      child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Expanded(
                              child: HomeimageContainer('assets/Birdseagull.png',(){
                            ...
                            Expanded(
                              child: HomeimageContainer('assets/B08.png',(){
                                ...
                                Navigator.push(
                                  context, MaterialPageRoute(builder: (context) => Quiz25()),
                                );
