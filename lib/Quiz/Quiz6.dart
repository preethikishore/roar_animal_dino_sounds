          ...
          body: SafeArea(
            child: Padding(
              ...
              child: Container(
                child: Column(
                  children: <Widget>[
                    Expanded(child: QuizPanel('Black Panther','NameAnimalpanther.mp3')),
                    Expanded(
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: <Widget>[
                          Expanded(
                            child: HomeimageContainer('assets/F08.png',()=>p.SoundClick('musicno.mp3')),
                          ),
                          Expanded(
                            child: HomeimageContainer('assets/A14.png',(){
                              p.SoundClick('musicyes.mp3');
                              Navigator.push(
                                context, MaterialPageRoute(builder: (context) => Quiz7()),
                              );
                            },),
                          ),
                    ...
                    Expanded(
                      child: Row(
                          ...
                          children: <Widget>[
                            Expanded(
                              child: HomeimageContainer('assets/A18.png',()=>p.SoundClick('musicno.mp3')),
                            ),
                            Expanded(
