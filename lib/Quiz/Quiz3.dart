...
import 'package:roar_animal_dino_sounds/Quiz/Quiz4.dart';
              ...
              child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Expanded(child: QuizPanel('Lemur','NameAnimallemur.mp3')),
                    Expanded(
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                            child: HomeimageContainer('assets/A11.png',(){p.SoundClick('musicyes.mp3');
                              Navigator.push(
                                context, MaterialPageRoute(builder: (context) => Quiz4()),
                              );
                            },
                            ),
                          ),
