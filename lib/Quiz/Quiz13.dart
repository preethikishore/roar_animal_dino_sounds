...
import 'package:roar_animal_dino_sounds/Quiz/Quiz14.dart';
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Expanded(child: QuizPanel('Horse','NameFarmhorse.mp3')),
                    ...
                    Expanded(
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                            child: HomeimageContainer('assets/F04.png',()=> p.SoundClick('musicno.mp3')),
                          ),
                        ],
                      ),
                    ),
                    ...
                    Expanded(
                      child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Expanded(
                              child: HomeimageContainer('assets/F06.png',(){

                                p.SoundClick('musicyes.mp3');
                                Navigator.push(
                                  context, MaterialPageRoute(builder: (context) => Quiz14()),
                                );},),
                            ),
                          ]
                      ),
