...
import 'package:roar_animal_dino_sounds/Quiz/Quiz11.dart';
              ...
              child: Container(
                child: Column(
                  children: <Widget>[
                    ...
                    Expanded(child: QuizPanel('Donkey','NameFarmdonkey.mp3')),
                    ...
                    Expanded(
                      child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Expanded(
                              child: HomeimageContainer('assets/F05.png',(){
                                p.SoundClick('musicyes.mp3');
                                Navigator.push(
                                  context, MaterialPageRoute(builder: (context) => Quiz11()),
                                );
                              },),
                            ),
